...
from pyjnu.exceptions.custom_exceptions import custom_warnings, ConfigurationFileCorrupt
from pyjnu.io.package_data import get_path_of_data_file, get_path_of_user_dir

_config_file_name = 'pyjnu_config.yml'
...
class Config(object):
    ...
    def __init__(self):
        ...
        assert os.path.exists(default_configuration_path), \
            "Default configuration %s does not exist. Re-install pyjnu" % default_configuration_path
        ...
        # Check if the user has a user-supplied config file under .pyjnu
